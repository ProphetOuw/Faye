...
:::
:::tip Class Name Autocomplete
`Thread:Create("...")` suggests every creatable Roblox class name. Studio does this out of the box; in VS Code (luau-lsp) press **Ctrl+Space** inside the quotes, or enable `editor.quickSuggestions.strings` for `[luau]` in your settings so it pops up automatically, see the [Introduction](/docs/intro) for the snippet.
:::
## Installation
